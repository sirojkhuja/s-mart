                                ...
                                <form id="register-form" role="form" autocomplete="off" class="form" method="post">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input id="resetcode" name="resetcode"
                                                   placeholder="Input your Code Number here" class="form-control"
                        ...
                        <div class="text-center">
                            ...
                            <div class="panel-body">
                                ...
                                <form id="register-form" role="form" autocomplete="off" class="form" method="post">
                                    ...
                                    <div class="form-group">
                                        <input name="savepass-submit" class="btn btn-lg btn-primary btn-block"
