...
<div class="row">
    ...
    <div class="form-group">
        <div class="col-md-8">
            ...
            <div class="col-md-8">
                <input type="text" class="form-control input-sm" id="PRODNAME" name="PRODNAME" cols="1" rows="3" value="<?php echo $singleproduct->PRODNAME; ?>"/>
            </div>
        </div>
    </div>
    ...
    <div class="form-group">
        <div class="col-md-8">
            ...
            <div class="col-md-8">
                ...
                <textarea class="form-control input-sm" id="PRODESC" name="PRODESC" cols="1"
                          rows="3"><?php echo $singleproduct->PRODESC; ?>
                      </textarea>
    ...
    <div class="form-group">
        <div class="col-md-8">
            <label class="col-md-4 control-label" for=
            "PRODMEAS">Measurement:</label>

            <div class="col-md-8">
                <input class="form-control input-sm" id="PRODMEAS" name="PRODMEAS" placeholder=
                "Measurement" type="text" value="<?php echo $singleproduct->PRODMEAS; ?>">
            </div>
